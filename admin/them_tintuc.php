...
<form action="" method="post" enctype="multipart/form-data">
      ...
      <table>
    		...
    		<tr>
            	<td>Nội dung ngắn</td><td><textarea name="ndngan" style="width: 300px; height: 100px"></textarea></td>
            </tr>
            <tr>
            	<td>Nội dung chi tiết</td><td><textarea name="noidung" style="width: 300px; height: 300px"></textarea></td>
            </tr> 
			<tr>
